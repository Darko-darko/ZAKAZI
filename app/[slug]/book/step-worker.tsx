      ...
      <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-3">
        {workers.map((worker) => (
          <Link
            ...
            className="overflow-hidden rounded-md border border-border bg-card transition hover:border-primary hover:ring-2 hover:ring-primary/15"
          >
            {worker.photo_url ? (
              ...
              <span className="flex aspect-square w-full items-center justify-center bg-muted text-4xl font-bold text-muted-foreground">
